...
export const FETCH_CUSTOM_ANALYZE_DATA_REQUEST =
  "FETCH_CUSTOM_ANALYZE_DATA_REQUEST";
export const FETCH_CUSTOM_ANALYZE_DATA_SUCCESS =
  "FETCH_CUSTOM_ANALYZE_DATA_SUCCESS";
export const FETCH_CUSTOM_ANALYZE_DATA_FAILURE =
  "FETCH_CUSTOM_ANALYZE_DATA_FAILURE";
export const RESET_ANALYZE_STATE = "RESET_ANALYZE_STATE";
...
export const resetAnalyzeState = () => ({
  type: RESET_ANALYZE_STATE,
});
